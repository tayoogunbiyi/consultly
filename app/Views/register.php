            ...
            <div class="centralised-section">
                ...
                <form>
                    <div class="form-group my-3">
                        ...
                        <input type="text" class="custom-textbox-input form-control" placeholder="Please enter your company name">
                    </div>
                    <div class="form-group my-3">
                        <label class="custom-label">Company email</label>
                        <input type="email" class="custom-textbox-input form-control" placeholder="Please enter your email">
                    </div>
                    <div class="form-group my-3">
                        <label class="custom-label">Company number</label>
                       <input type="number" class="custom-textbox-input form-control" placeholder="Please enter your number">
                    </div>
                    <div class="form-group my-3">
                    ...
                    <div class="form-group my-3">
                        ...
                        <input type="password" class="custom-textbox-input form-control" placeholder="Please confirm your password">
                    </div>
                    <div class="form-group my-3">
